...
print("[PASS] PASS: Transaction committed successfully")
...
print("[v] Changes staged (INSERT + DELETE)")
...
print("[PASS] PASS: Transaction rolled back successfully")
...
print("[v] Table 'transactions' created")
...
print("[v] Modified 2 tables in transaction")

# Commit
commit_result2 = db.execute_query("COMMIT")
print(f"[v] {commit_result2}")
...
print("[PASS] PASS: Multi-table transaction committed")
...
print("[v] Direct INSERT (auto-commit)")
...
print("[PASS] PASS: Auto-commit mode works")
...
try:
    ...
    print("[v] COMMIT without transaction raises error")
...
try:
    ...
    print("[v] ROLLBACK without transaction raises error")
...
try:
    ...
    print("[v] Nested BEGIN raises error")
    db.execute_query("ROLLBACK")  # Clean up

print("[PASS] PASS: Error handling works correctly")
...
print("[v] Inserted Frank in transaction")
...
print("[v] SELECT sees staged changes")
...
print("[PASS] PASS: Transaction isolation works")
...
print("[v] Updated multiple rows in transaction")
...
print("[PASS] PASS: Complex UPDATE committed")
...
print("[v] Deleted rows in transaction")
...
print("[PASS] PASS: DELETE rollback works")

print("\n" + "="*70)
print("[PASS] ALL TRANSACTION TESTS PASSED")
print("="*70)

print("\nTransaction Features Verified:")
print("  [v] BEGIN TRANSACTION")
print("  [v] COMMIT (single and multi-table)")
print("  [v] ROLLBACK")
print("  [v] Auto-commit mode")
print("  [v] Transaction isolation")
print("  [v] INSERT/UPDATE/DELETE in transactions")
print("  [v] Error handling")
print("  [v] Staging area functionality")
print("\n" + "="*70)
