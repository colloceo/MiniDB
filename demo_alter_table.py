...
print("✓ Table 'employees' created with columns: id, name")
...
print("✓ Updated Alice and Bob's email and salary")
...
print("✓ Inserted Diana with complete information")
...
print("✓ Added department column and updated values")
...
print("✓ Schema and data persisted correctly!")

print("\n" + "="*70)
print("✅ ALTER TABLE FEATURE DEMONSTRATION COMPLETE")
print("="*70)
print("\nKey Features Demonstrated:")
print("  ✓ Dynamic schema modification (ALTER TABLE ADD COLUMN)")
print("  ✓ Type-based default values (INT→0, STR→'')")
print("  ✓ Existing rows automatically updated")
print("  ✓ New columns can be updated and queried")
print("  ✓ New rows include all columns")
print("  ✓ Schema changes persist across restarts")
print("  ✓ Atomic operations ensure data integrity")
print("\n" + "="*70 + "\n")
