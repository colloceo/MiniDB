...
print("✓ Created table with 4 columns and 2 rows")
...
print(f"✓ Columns after drop: {desc['columns']}")
...
print("✅ PASS: DROP COLUMN works correctly")
...
try:
    ...
    if "SchemaError" in str(type(e).__name__) or "primary key" in str(e).lower():
        print(f"✓ SchemaError raised: {e}")
        print("✅ PASS: Cannot drop primary key column")
    else:
...
try:
    ...
    if "ValidationError" in str(type(e).__name__) or "does not exist" in str(e):
        ...
        print("✅ PASS: Error on non-existent column")
    else:
        print(f"❌ Wrong error type: {type(e).__name__}")
...
print(f"✓ Columns after rename: {desc['columns']}")
...
print("✅ PASS: RENAME COLUMN works correctly")
...
print(f"✓ Primary key updated: {desc['primary_key']}")
...
print("✅ PASS: Primary key rename works")
...
try:
    ...
    if "ValidationError" in str(type(e).__name__) or "already exists" in str(e):
        print(f"✓ ValidationError raised: {e}")
        print("✅ PASS: Error on duplicate column name")
    else:
        print(f"❌ Wrong error type: {type(e).__name__}")
...
print("✓ Created table with UNIQUE constraint")
...
print(f"✓ Unique columns after drop: {desc['unique_columns']}")

print("✅ PASS: DROP COLUMN removes constraints")
...
print(f"✓ Constraints updated: unique={desc['unique_columns']}, fk={desc['foreign_keys']}")

print("✅ PASS: RENAME COLUMN updates constraints")
...
print(f"✓ Schema persisted: {desc['columns']}")
...
print(f"✓ Data persisted: {data}")

print("✅ PASS: Schema changes persist to disk")
...
print("✓ Created employees table with 6 columns")
...
print("✓ Performed multiple schema changes")
...
print(f"✓ Final columns: {desc['columns']}")
...
print("✅ PASS: Complex scenario works correctly")
...
print("\nFeatures Verified:")
print("  ✓ DROP COLUMN - Basic functionality")
print("  ✓ DROP COLUMN - Primary key protection")
print("  ✓ DROP COLUMN - Non-existent column error")
print("  ✓ DROP COLUMN - Constraint removal")
print("  ✓ RENAME COLUMN - Basic functionality")
print("  ✓ RENAME COLUMN - Primary key rename")
print("  ✓ RENAME COLUMN - Duplicate name error")
print("  ✓ RENAME COLUMN - Non-existent column error")
print("  ✓ RENAME COLUMN - Constraint updates")
print("  ✓ Persistence - Schema changes persist")
print("  ✓ Complex scenarios - Multiple operations")

print("\nSafety Features:")
print("  ✓ Cannot drop primary key column")
print("  ✓ Validation for non-existent columns")
print("  ✓ Duplicate name detection")
print("  ✓ Atomic saves after each operation")
